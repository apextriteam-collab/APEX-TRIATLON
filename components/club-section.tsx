...
export function ClubSection() {
  return (
    <section id="club" className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
      <div className="grid items-center gap-12 lg:grid-cols-2">
        ...
        <div>
          <span className="text-sm font-semibold uppercase tracking-widest text-White">Somos APEX</span>
